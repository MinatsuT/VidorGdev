...
# Thu Apr 04 01:26:52 JST 2019
# DO NOT MODIFY


# 
# VID_MIXER "Video Mixer" v1.0
# Minatsu Tukisima 2019.04.04.01:26:52
# 
# 
...
add_fileset_file BG.sv SYSTEM_VERILOG PATH BG.sv
add_fileset_file VID_MIXER.pkg OTHER PATH VID_MIXER.pkg


# 
# parameters
# 
add_parameter pADDR_BITS INTEGER 22
set_parameter_property pADDR_BITS DEFAULT_VALUE 22
set_parameter_property pADDR_BITS DISPLAY_NAME pADDR_BITS
set_parameter_property pADDR_BITS TYPE INTEGER
set_parameter_property pADDR_BITS UNITS None
set_parameter_property pADDR_BITS HDL_PARAMETER true
...
add_interface_port SDRAM oSDRAM_ADDRESS address Output pADDR_BITS
